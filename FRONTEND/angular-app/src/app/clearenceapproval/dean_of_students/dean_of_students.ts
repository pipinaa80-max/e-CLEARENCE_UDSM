...
export class DeanOfStudentsComponent {
  ...
  get requests(): ClearanceRequest[] {
    return this.clearanceService.getRequestsForOffice('Dean of Students');
  }
  ...
  approve(request: ClearanceRequest): void {
    ...
    this.notificationService.createNotification(
      ...
      'The Dean of Students has approved your clearance request.',
      'success'
    );
  ...
  reject(): void {
    ...
    this.notificationService.createNotification(
      ...
      'Dean of Students action required',
      this.rejectionComment,
      'warning'
    );
